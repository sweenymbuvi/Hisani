...
import 'package:web_admin/views/screens/Vacancies_screen.dart';
import 'package:web_admin/views/screens/applications_screen.dart';
...
import 'package:web_admin/views/screens/donationsScreen.dart';
...
import 'package:web_admin/views/screens/organisations_screen.dart';
import 'package:web_admin/views/screens/physical_donations_screen.dart';
import 'package:web_admin/views/screens/register_screen.dart';
import 'package:web_admin/views/screens/statistics_screen.dart';
...
class RouteUri {
  ...
  static const String physicalDonations = '/physicalDonations';
...
const List<String> publicRoutes = [
   ...
   RouteUri.register, 
   RouteUri.dashboard,
   RouteUri.organisations,
   RouteUri.users,
   RouteUri.myProfile,
   RouteUri.crud,
   RouteUri.crudDetail,
   RouteUri.applications,
   RouteUri.donations,
   RouteUri.physicalDonations,
   RouteUri.statistics,
    RouteUri.vacancy
];
...
GoRouter appRouter(UserDataProvider userDataProvider) {
  return GoRouter(
    ...
    GoRoute(
      path: RouteUri.physicalDonations,
      pageBuilder: (context, state) => NoTransitionPage<void>(
        key: state.pageKey,
        child: PhysicalDonationsScreen(),
      ),
    ),
