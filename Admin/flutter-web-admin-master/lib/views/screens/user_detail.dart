...
class _UserDetailsScreenState extends State<UserDetailsScreen> {
  ...
  Future<String> _uploadImage() async {
    if (_image != null && _fileName != null) {
      try {
        Reference ref = _storage.ref().child('profile_pics').child(_fileName!);
  ...
  void _doSubmit(BuildContext context) async {
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      _formData['ProfilePicUrl'] = await _uploadImage();
        ...
        FirebaseFirestore.instance
          ...
          AwesomeDialog(
            ...
            btnOkOnPress: () {
              ...
              GoRouter.of(context).go(RouteUri.users); // Navigate back to users screen
            },
          ).show();
        }).catchError((error) {
          AwesomeDialog(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FormBuilderTextField(
                        ...
                        onChanged: (value) {
                          _formData['SecondaryPhone'] = value;
                        },
                      ),
                    ),
                      Padding(
