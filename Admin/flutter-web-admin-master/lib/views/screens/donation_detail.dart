...
class _DonationDetailState extends State<DonationDetail> {
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      docRef.update(_formData).then(() {
        AwesomeDialog(
          ...
          width: kDialogWidth,
          btnOkText: 'OK',
          btnOkOnPress: () => GoRouter.of(context).go(RouteUri.donations),
        ).show();
  ...
  Widget build(BuildContext context) {
    ...
    final pageTitle = 'Manage Cash Donations';

    return PortalMasterLayout(
      selectedMenuUri: RouteUri.donations,
      body: ListView(
