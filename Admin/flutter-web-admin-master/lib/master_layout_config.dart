...
final sidebarMenuConfigs = [
 ...
 SidebarMenuConfig(
    ...
    title: (context) => Lang.of(context).users,
  ),
SidebarMenuConfig(
    uri: RouteUri.crud,
    icon: Icons.business_rounded,
    title: (context) => 'Organisations', 
  ),
SidebarMenuConfig(
    uri: RouteUri.applications,
    icon: Icons.business_rounded,
    title: (context) => 'Volunteer Applications', 
  ),
    SidebarMenuConfig(
    uri: RouteUri.vacancy,
    icon: Icons.business_rounded,
    title: (context) => 'Volunteer Vacancies', 
  ),
   
  SidebarMenuConfig(
    uri: RouteUri.donations,
    icon: Icons.business_rounded,
    title: (context) => 'Cash Donations', 
  ),
  SidebarMenuConfig(
    uri: RouteUri.physicalDonations,
    icon: Icons.business_rounded,
    title: (context) => 'Physical Donations', 
  ),
SidebarMenuConfig(
    uri: RouteUri.statistics,
    icon: Icons.business_rounded,
