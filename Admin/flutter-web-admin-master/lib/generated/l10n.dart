...
class Lang {
  ...
  // In your localization file (e.g., en.dart)
...
String? validatePassword(String value) {
    ...
    } else if (!RegExp(r'^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).+$').hasMatch(value)) {
  ...
  String get passwordHint {
    return 'At least 8 characters. A combination of uppercase letters, lowercase letters, numbers, and symbols.';
  }
...
String get continueToDashboard {
  ...
  String get update {
   ...
   String get recordSubmitFailed{
    return Intl.message(
      'Record Failed To Submit',
      name: 'recordSubmitFailed',
      desc: '',
      args: [],
    );
  }
